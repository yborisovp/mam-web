            ...
            <div className={styles.container + " container mt-4 mb-3"}>
                <div className="row">
                    <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-4 rounded-2">
                        <Carousel
                            fade
                            className={styles.sticky + " mb-4 w-100 shadow-1-strong rounded-2 align-self-center sticky-top"}
                            activeIndex={index}
                    ...
                    <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 pe-0">
                            ...
                            <div className="row mx-0">
                                <div className="col-12 p-0">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <h4 className={styles["item-title"] + "mb-2 m-0"}>4 500 000 ₽</h4>
                                    </div>

                                    <h6 className="mb-0 font-monospace text-color-demigray">24 марта № 1118483189</h6>
                                </div>
                            </div>
                        ...
                        <div className={styles["card-main"] + " card p-3 mb-3"}>
                            ...
                            <ReactMarkdown>
                            Тойота Витц 2017 года выпуска - это компактный и надежный хэтчбек, который идеально подойдет для городской езды. Автомобиль находится в прекрасном состоянии и имеет пробег всего 30 тысяч километров.
...
Заключение
Если вы ищете надежный, компактный и стильный автомобиль для городской езды, то Toyota Vitz 2017 - отличный выбор. Свяжитесь с нами, чтобы узнать больше о этом автомобиле и возможных вариантах приобретения.
                            </ReactMarkdown>
                        </div>
